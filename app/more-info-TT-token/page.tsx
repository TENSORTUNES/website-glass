...
export default function BuyTTTGuide({
  ...
  return (
    <div className={`container mx-auto p-4 xl:p-12 ${className ?? ""}`}>
      {/* Heading */}
      <div className="mb-8">
        <div className="grid grid-cols-3 items-center">
          ...
          <div className="text-center">
            ...
            <p className="opacity-80">
              A simple, step-by-step guide to set up a Solana wallet and swap
              SOL → TTT.
            </p>
          </div>

          {/* Right: reserved (optional) */}
      ...
      <div className="grid gap-6 md:gap-8">
        ...
        <Card className="border border-white/30 bg-black/30 glass backdrop-blur backdrop-saturate-300">
          <CardHeader>
          ...
          <CardContent className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 bg-white/20 rounded-lg hover:bg-white/30 transition-colors">
                ...
                <div className="flex flex-col lg:flex-row gap-2 justify-center mt-3">
