      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="glass p-6 rounded-2xl text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-3">AI-Driven Music</h3>
          ...
          <div className="glass p-6 rounded-2xl text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Ecosystem Growth</h3>
            <p className="text-white/60 leading-relaxed">
          ...
          <div className="glass p-6 rounded-2xl text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Commercial Ready</h3>
            <p className="text-white/60 leading-relaxed">
